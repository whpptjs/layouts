      ...
      <div v-for="(contentGroup, index) in content" :key="contentGroup.key + index">
        <component
          ...
          :class="[
            ...
            `mt-${$whppt.spacing(contentGroup.marginTopSmall || $whppt.defaultMarginTop) * 4} sm:mt-${
              $whppt.spacing(contentGroup.marginTopMedium || contentGroup.marginTopSmall || $whppt.defaultMarginTop) * 4
            } lg:mt-${
              $whppt.spacing(

...
module.exports = function (moduleOptions) {
  ...
  this.addTemplate({
    src: resolve(__dirname, 'components/icons/Columns.vue'),
    fileName: join(filesDir, 'components/icons/Columns.vue'),
    options,
  });

  this.addTemplate({
    src: resolve(__dirname, 'components/icons/Padding.vue'),
    fileName: join(filesDir, 'components/icons/Padding.vue'),
    options,
  });
};
